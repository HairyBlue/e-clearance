    ...
    <form action="/superadmin/store" method="POST" class="lg:w-3/5 w-full">
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-4">
                ...
                <p class="text-sm leading-6 text-gray-600"><span class="font-medium">Note: </span>Use a valid email from the staff for their registration. This will be used to notify them after registration.</p>
